...
export default function GeorgiaMap() {
  ...
  // Points of interest with Georgian culinary specialties
  const culinaryPoints = [
    {
      id: "kakheti",
      region: "Kakheti",
      x: 700,
      y: 250,
      image: "/images/7158.jpg",
      specialty: {
        en: "Wine Heritage",
        ru: "Винное наследие",
        et: "Veinitraditsioonid",
      },
      description: {
        en: "Each glass is like a story about the sun, vineyards, and centuries of Georgian traditions.",
        ru: "Каждый бокал — как рассказ о солнце, виноградниках и столетиях грузинских традиций.",
        et: "Iga klaas on nagu lugu päikesest, viinamarjaistandustest ja sajanditepikkustest Gruusia traditsioonidest.",
      },
    },
    {
      id: "imereti",
      ...
      description: {
        en: "Golden, stretchy, hot — khachapuri, embodying the warmth and joy of Georgian feasts.",
        ru: "Золотистые, тянущиеся, горячие — хачапури, в которых живёт уют и радость грузинского застолья.",
        et: "Kuldse värvi, veniv, kuum – khachapuri, milles peitub Gruusia pidusöögi hubasus ja rõõm.",
      },
    },
    {
      id: "svaneti",
      ...
      description: {
        en: "The strong aroma of the mountains and the richness of herbs and spices in Svaneti whet the appetite and invite you to discover new flavors.",
        ru: "Сильный аромат гор, богатство трав — специи Сванетии будят аппетит и зовут к новым вкусам.",
        et: "Mägede tugev aroom, rikkalikud maitsetaimed – Svanetia vürtsid äratavad isu ja kutsuvad avastama uusi maitseid.",
      },
    },
  ];
  ...
  const regionNames = {
    "GE-AB": { en: "Abkhazia", ru: "Абхазия", et: "Abhaasia" },
    "GE-AJ": { en: "Ajaria", ru: "Аджария", et: "Adžaaria" },
    "GE-GU": { en: "Guria", ru: "Гурия", et: "Guria" },
    "GE-IM": { en: "Imereti", ru: "Имеретия", et: "Imeretia" },
    "GE-KA": { en: "Kakheti", ru: "Кахетия", et: "Kahhetia" },
    "GE-KK": { en: "Kvemo Kartli", ru: "Квемо Картли", et: "Kvemo Kartli" },
    "GE-MM": {
      en: "Mtskheta-Mtianeti",
      ru: "Мцхета-Мтианети",
      et: "Mtskheta-Mtianeti",
    },
    "GE-RL": {
      en: "Racha-Lechkhumi",
      ru: "Рача-Лечхуми",
    ...
    "GE-SJ": {
      ...
      ru: "Самцхе-Джавахети",
      et: "Samtshhe-Džavahhetia",
    },
    "GE-SK": { en: "Shida Kartli", ru: "Шида Картли", et: "Šida Kartli" },
    "GE-SZ": {
      en: "Samegrelo-Zemo Svaneti",
      ru: "Самегрело-Земо Сванети",
      et: "Samegrelo-Zemo Svaneti",
    },
    "GE-TB": { en: "Tbilisi", ru: "Тбилиси", et: "Thbilisi" },
  };
  ...
  // Get point position in pixels relative to SVG container
  const getPointPosition = (point) => {
    const svgContainer = document.querySelector(".map-svg-container");
    ...
    if (x + popupWidth / 2 > rect.width) {
      x = rect.width - popupWidth / 2 - 10;
    } else if (x - popupWidth / 2 < 0) {
      x = popupWidth / 2 + 10;
    }

    if (y + popupHeight + 20 > rect.height) {
      // Show popup above the point if it would overflow bottom
      y = y - popupHeight - 20;
    }
  ...
  // Close clicked point when clicking outside
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (
        !e.target.closest(".culinary-point") &&
        !e.target.closest(".point-image-popup")
      ) {
  ...
  const getContent = () => {
    switch (locale) {
      case "ru":
        return {
          title: "Вкусы Грузии",
          subtitle: "Каждый уголок Грузии дарит особый вкус",
        };
      case "en":
        return {
          title: "Flavors from Georgia",
          subtitle: "Every corner of Georgia offers a unique taste",
        };
      default:
        return {
          title: "Gruusia maitsed",
          subtitle: "Iga Gruusia nurk pakub ainulaadset maitset",
        };
    }
  };
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Set initial states
      gsap.set(".map-title", { opacity: 0, y: 60 });
      gsap.set(".map-subtitle", { opacity: 0, y: 40 });
      gsap.set(".culinary-card", { opacity: 0, y: 80 });
      gsap.set(".map-svg-container", { opacity: 0, scale: 0.95 });
      gsap.set(".culinary-point", { scale: 0, opacity: 0 });
      ...
      gsap.to(".culinary-card", {
        ...
        ease: "power3.out",
        scrollTrigger: {
          trigger: ".culinary-cards",
          start: "top 75%",
          toggleActions: "play none none reverse",
        },
      });

      // SVG Map elegant entrance
      gsap.to(".map-svg-container", {
        scale: 1,
        opacity: 1,
        duration: 1.4,
        ease: "power2.out",
        scrollTrigger: {
          trigger: ".map-svg-container",
          start: "top 70%",
          toggleActions: "play none none reverse",
        },
      });
      ...
      // Animate regions on hover setup
      const regions = gsap.utils.toArray(".land");
      ...
      const cards = gsap.utils.toArray(".culinary-card");
      cards.forEach((card) => {
      ...
      // Culinary points elegant appearance
      gsap.to(".culinary-point", {
        scale: 1,
        opacity: 1,
        duration: 0.6,
        stagger: 0.15,
      ...
      // Subtle floating animation for points
      gsap.to(".culinary-point", {
        y: -5,
        duration: 2,
        repeat: -1,
  ...
  return (
    <section ref={mapRef} className="georgia-map-section">
      <div className="georgia-map-container">
        {/* Header */}
        <div className="map-header">
          <h2 className="map-title">{content.title}</h2>
          <p className="map-subtitle">{content.subtitle}</p>
        </div>
        ...
        <div className="map-wrapper">
          ...
          <div className="culinary-cards">
            {culinaryPoints.map((point, index) => (
              <div key={point.id} className="culinary-card">
                <h3 className="card-title">{point.specialty[locale]}</h3>
                <p className="card-region">{point.region}</p>
                <p className="card-description">{point.description[locale]}</p>
              </div>
            ))}
          </div>
          {/* SVG Map */}
          <div className="map-svg-container" onMouseMove={handleMouseMove}>
            ...
            >
              <path
                ...
                title="Abkhazia"
                className="land"
                onMouseEnter={() => handleRegionHover("GE-AB")}
              ...
              <path
                ...
                title="Ajaria"
                className="land"
                onMouseEnter={() => handleRegionHover("GE-AJ")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                title="Guria"
                className="land"
                onMouseEnter={() => handleRegionHover("GE-GU")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                title="Imereti"
                className="land"
                onMouseEnter={() => handleRegionHover("GE-IM")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                title="K'akheti"
                className="land"
                onMouseEnter={() => handleRegionHover("GE-KA")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                title="Kvemo Kartli"
                className="land"
                onMouseEnter={() => handleRegionHover("GE-KK")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                className="land"
                onMouseEnter={() => handleRegionHover("GE-MM")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                className="land"
                onMouseEnter={() => handleRegionHover("GE-RL")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                className="land"
                onMouseEnter={() => handleRegionHover("GE-SJ")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                title="Shida Kartli"
                className="land"
                onMouseEnter={() => handleRegionHover("GE-SK")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                className="land"
                onMouseEnter={() => handleRegionHover("GE-SZ")}
                onMouseLeave={handleRegionLeave}
              ...
              <path
                ...
                title="Tbilisi"
                className="land"
                onMouseEnter={() => handleRegionHover("GE-TB")}
                onMouseLeave={handleRegionLeave}
              ...
              {/* Culinary Points */}
              {culinaryPoints.map((point) => (
                <g key={point.id}>
                  <circle
                    cx={point.x}
                    cy={point.y}
                    r="8"
                    className="culinary-point"
                    style={{ cursor: "pointer" }}
                    onMouseEnter={() => handlePointHover(point.id)}
                    onMouseLeave={handlePointLeave}
                    onClick={() => handlePointClick(point.id)}
                  />
                  <text x={point.x} y={point.y + 25} className="point-label">
                    {point.region}
                  </text>
                </g>
              ))}
            ...
            {/* Mobile Overlay */}
            {clickedPoint && window.innerWidth <= 768 && (
              <div
            ...
            {hoveredRegion && regionNames[hoveredRegion] && (
              ...
              >
                {regionNames[hoveredRegion][locale]}
              </div>
            )}
            ...
            {(hoveredPoint || clickedPoint) &&
              (() => {
                const point = culinaryPoints.find(
                  (p) => p.id === (hoveredPoint || clickedPoint),
                );
                const position = getPointPosition(point);

                return (
                  <div
                    className="point-image-popup"
                    style={{
                      left: `${position.x}px`,
                      top: `${position.y + 20}px`,
                    }}
                  >
                    <img src={point?.image} alt={point?.region} />
                    <div className="popup-title">{point?.id}</div>
                  </div>
                );
              })()}
          </div>
